                                        ...
                                        steps{
                                            timeout(10){
                                                sh(
                                                    ...
                                                    script: '''.venv/bin/uv pip install "uiucprescon.build @ https://github.com/UIUCLibrary/uiucprescon_build/releases/download/v0.4.2/uiucprescon_build-0.4.2-py3-none-any.whl"
                                                               . .venv/bin/activate
