                                                    ...
                                                    timeout(10){
                                                        sh(
                                                            ...
                                                            script: '''mkdir -p reports/pytestcoverage
                                                                       ...
                                                                       uv run gcovr --root . --filter src/uiucprescon/ocr --exclude-directories build/python/temp/conan_cache --print-summary --keep --gcov-object-directory=$WORKSPACE/cpp_extension_tests_coverage_data build/lib
                                                                    '''
                                                        )
                                                    }
                                                }
                                            ...
                                            stage('C++ Tests') {
                                                steps{
                                                    ...
                                                    sh '''mkdir -p reports/coverage
                                                          uv run gcovr --root $WORKSPACE --filter=src/uiucprescon/ocr --print-summary --json=$WORKSPACE/reports/coverage/coverage_cpp_tests.json --txt=$WORKSPACE/reports/coverage/text_cpp_tests_summary.txt --gcov-object-directory=$WORKSPACE/cpp_extension_tests_coverage_data build/cpp
                                        ...
                                        post{
                                            always{
                                                sh(script: '''mkdir -p build/coverage
                                                              ...
                                                              uv run gcovr --root . --filter src/uiucprescon/ocr --exclude-directories build/python/temp/conan_cache --print-summary --keep --json -o reports/coverage/coverage-c-extension_tests.json --txt reports/coverage/coverage-c-extension_tests --gcov-object-directory=$WORKSPACE/cpp_tests_coverage_data build/lib
