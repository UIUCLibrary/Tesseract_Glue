                                            ...
                                            stage('C++ Tests') {
                                                steps{
                                                    ...
                                                    sh '''mkdir -p reports/coverage
                                                          ...
                                                          uv run gcovr --root $WORKSPACE --print-summary  --keep --json $WORKSPACE/reports/coverage/coverage_cpp_tests.json --txt $WORKSPACE/reports/coverage/text_cpp_tests_summary.txt --gcov-object-directory $WORKSPACE/coverage_data build/cpp
