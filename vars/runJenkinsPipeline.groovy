                                                                    ...
                                                                    timeout(10){
                                                                        sh(
                                                                            ...
                                                                            script: '''mkdir -p reports/pytestcoverage
                                                                                       ...
                                                                                       ls -laR build/temp
                                                                                       uv run gcovr --root $WORKSPACE --filter=src/uiucprescon/ocr --exclude-directories build/python/temp/conan_cache --print-summary  build/temp
                                                                                    '''
                                                                        )
                                                                    }
                                                                }
                                                            ...
                                                            stage('C++ Tests') {
                                                                steps{
                                                                    ...
                                                                    sh '''mkdir -p reports/coverage
                                                                          uv run gcovr --root $WORKSPACE --filter=src/uiucprescon/ocr --keep -print-summary --json=$WORKSPACE/reports/coverage/coverage_cpp_tests.json --txt=$WORKSPACE/reports/coverage/text_cpp_tests_summary.txt
